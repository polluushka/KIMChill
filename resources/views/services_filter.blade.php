        ...
        <div class="min-container">
            ...
            <div class="mb-1">
                ...
                <div class="button-end">
                    <select style="width: 30%" v-model="category_filter_id" name="category_filter" id="category_filter"
                            :class="{
                                    'p-light': theme === 'light',
                                    'p-night': theme !== 'light',
                        ...
                        <tr v-for="(week, index_week) in (Math.floor(selected_mouth.days / 7))">
                            <td v-for="day in 7" :key="(7 - selected_mouth.skipDays) + day" v-if="index_week === 0">
                                <button name="day[]" :id="`${(7 - selected_mouth.skipDays) + day}`" type="button" class="btn-calendar"
                                        ...
                                        || (btnColor((7 - selected_mouth.skipDays) + day) ? 'btn-calendar-date-yes':'btn-calendar-hidden-light')">
        ...
        const App = {
            ...
            methods: {
                ...
                async getServices() {
                    ...
                    this.category_filter_id = window.location.href.split('/').at(-1);
                },
                async getUser() {
